...
app.get('/companies', function (req, res) {
    ...
    getResult(function (err, result) {
        if (err) {
            console.log("Database error!"); throw err;
        } else {
...
app.post('/create', function (req, res) {
    console.log(req)
    var sql = "INSERT INTO companies(name, street, postcode, city, business_id, email, phone)"
        + " values(?,?,?,?,?,?,?)";
    con.query(sql, [req.body.name, req.body.street, req.body.postcode, req.body.city, req.body.business_id, req.body.email, req.body.phone], function (err, result) {
        if (err) throw err;
        console.log(result);
    });
    res.json("")
